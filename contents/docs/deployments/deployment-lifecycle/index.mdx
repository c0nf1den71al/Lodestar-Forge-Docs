...
<Stepper>
  ...
  <StepperItem title="Stage 8: Destroying">
      ...
      Details on how to destroy a deployment can be found [here](/docs/deployments/managing-deployments#destroying-a-deployment).
  </StepperItem>

  <StepperItem title="Stage 9: Destroyed">
      This stage indicates that the deployment and its infrastructure have been successfully destroyed.
  </StepperItem>
</Stepper>
