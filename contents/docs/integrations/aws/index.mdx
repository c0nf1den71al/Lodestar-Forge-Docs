...
If your Lodestar Forge deployment is running on an EC2 instance, you can use [attached IAM roles](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/attach-iam-role.html) to authenticate with AWS.
...
Alternatively, the AWS integration supports an AWS Access Key ID, and AWS Secret Access Key. Whilst this documentation does not cover how to create AWS Access Keys, you can find instructions on how to do so [here](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_access-keys.html#Using_CreateAccessKey).
...
![Adding an AWS integration in Forge](/images/add-aws-integration)
