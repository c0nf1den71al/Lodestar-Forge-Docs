...
|Name|Description|
|---|---|
|adaptix-custom-profile.json|C2 profile utilised by Adaptix C2.|
|adaptix-service.service|Service file used by Adaptix C2.|
...
![Creating a new file in Forge](/images/create-file)
