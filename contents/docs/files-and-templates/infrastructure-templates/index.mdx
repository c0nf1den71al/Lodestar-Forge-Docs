...
|CloudFront Redirector|A template for deploying CloudFront redirectors. This template is only available for AWS infrastructure.|
...
![Creating a new infrastructure template in Forge](/images/create-infrastructure-template)
...
#### Instances/Hosts
A maximum of once instance, droplet, or host should be defined within your infrastructure templates. Infrastructure templates are designed to be modular and therefore, individual instances should be defined within each template.
