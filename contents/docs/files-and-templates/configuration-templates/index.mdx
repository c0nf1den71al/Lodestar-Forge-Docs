...
|Name|Description|
|---|---|
|Adaptix C2 Install|A template for installing and configuring Adaptix C2.|
...
|Mythic C2 Install|A template for installing and configuring Mythic C2.|
...
![Creating a new configuration template in Forge](/images/create-configuration-template)
